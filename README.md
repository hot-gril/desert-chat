...
Despite this techie stuff, Desert Chat is primarily for average people to use. Not everyone cares about the security, but it won't get in the way. Anonymity is not only for privacy but also usability, no dealing with accounts.
